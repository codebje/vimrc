...
let g:syntastic_haskell_hdevtools_args = '-g-ilib -g-isrc -g-i. -g-idist/build/autogen -g-Wall -g-fno-warn-missing-signatures -g-package-conf='.FindCabalSandboxRootPackageConf()
